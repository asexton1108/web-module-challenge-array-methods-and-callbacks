...
function getWinners(data, getFinalsCB) {
    return getFinalsCB(data).map(item => item['Home Team Goals'] > item['Away Team Gols'] ? item['Home Team Name'] : item['Away Team Name']);
}
...
function getWinnersByYear(data, getYearsCB, getWinnersCB) {
    ...
    return winners.map((item, index) => `In ${years[index]}, ${item} wond the world cup!`);
}
